    ...
    if not is_qa:
        if context.response_detail == "short":
            parts.append(
                "Guidance mode: Quick.\n"
                "QUICK MODE OVERRIDE:\n"
                "For ADVANCE/STAY decisions, the Quick criteria below take "
                "precedence over stage-specific wording that asks for medium, "
                "high, thorough, polished, or comprehensive development. Those "
                "higher stage-specific standards are the Strict-mode baseline.\n"
                ...
                "- Problem Identification: usable HMW (or equivalent) with a clear "
                "user/stakeholder, a need/problem/opportunity, and a desired "
                "outcome. Thin wording is acceptable. Do not require full root "
                "cause, validated barrier, complete evidence, or assumption-free "
                "framing. Example sufficient without an explicit barrier: How "
                "might we improve the road-crossing experience for elderly "
                "pedestrians so that they can cross busy roads safely and "
                "confidently?\n"
