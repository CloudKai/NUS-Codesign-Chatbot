...
column drag-resize, sources-panel scroll sizing, or composer footer placement.
Keep them small, side-effect free at import time, and call their ``sync_*`` /
render helpers explicitly from panel code.
"""
